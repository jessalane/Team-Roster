...
describe("employee", () => {
    describe('initialization', () => {
        it("should create an object with a name and age if provided valid arguments", () => {
            const Jane = new manager("Jane Doe", "email@domain.com", 1, 1);
        ...
        it("the email contains @", () => {
            const Jon = new manager("Jon Doe", "email@domain.com", 1, 1);
            expect(Jon.email).toContain("@");
        });

        it("should throw an error if not provided an id#", () => {
            const noID = () => new manager("Emily Doe", "email@domain.com", "", 1);
        ...
        it("should throw an error if not provided an office#", () => {
            const noOfficeNum = () => new manager("Emily Doe", "email@domain.com", 1, "");
        ...
        it("should throw an error if parameter 'email' is blank", () => {
            const noEmail = () => new manager("Emily Doe", "" , 1, 1);
        ...
        it("should throw an error if 'name' is not a string", () => {
            const numName = () => new manager(3, "email@domain.com", 1, 1);

            expect(numName).toThrow();
        });

        it("should throw an error if 'id' is not a number", () => {
            const idString = () => new manager("Jade Doe", "email@domain.com", '1', 1);

            expect(idString).toThrow();
        });

        it("should throw an error if 'officeNum' is not a number", () => {
            const officeString = () => new manager("Jade Doe", "email@domain.com", 1, "1");

            expect(officeString).toThrow();
        });

        it("should throw an error if 'id' is less than 0", () => {
            const negID = () => new manager("Jane Doe", "email@domain.com", -1, 1);
